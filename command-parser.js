...
function canTalk(user, room, connection, message) {
		...
		var horribleWords = new Array("cum","fgt","anal","porn","nigga","niqqa","whore", "cock", "jizz", "dick", "douche", "scumbag", "nigger", "cunt", "clit", "penis", "pussy", "faggot", "gayboy", "420yolo", "meatspin", "lemonparty", "panis", "n1gga", "n1qqa", "n1gger", "fagg0t", "f@gg0t", "f@ggot", "snen", "dongers", "playboy", "wh0re", "nigg@", "n1gg@", "n1qq@", "p3ni$", "p3nis", "peni$");
		
		if(botonz !== 0){
 		message.trim();
		for(x=0;x<horribleWords.length;x++){
		if(message.toLowerCase().indexOf(horribleWords[x]) > -1) {
			user.countBadWords++;
