...
var commands = exports.commands = {
	...
	shop: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('<center><h4><b><u>Pokemon Databse Shop</u></b></h4><table border="1" cellspacing ="0" cellpadding="3"><tr><th>Command</th><th>Description</th><th>Cost</th></tr>' +
	...
	removeitem: function(target, room, user) {
		...
		if (target === 'symbol') {
			...
			if (targetUser.canDecAdvertise) {
				...
				return this.sendReply('They do not have that ability for you to remove.');
		}
		else
			return this.sendReply('That isn\'t a real item!');
	},

	moneycommands: function(target, room, user) {
		if (!this.canBroadcast()) return;
		return this.sendReplyBox('Commands for the Point system:<br />' + 
			...
			'/atm [username] - Show your points or show someone else\'s points.');
	},
